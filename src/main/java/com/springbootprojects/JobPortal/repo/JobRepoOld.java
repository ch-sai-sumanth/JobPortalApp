...
public class JobRepoOld {
    ...
    public void updateJobPost(JobPost updatedJobPost) {

        for(JobPost job:jobs){
            if(job.getPostId()==updatedJobPost.getPostId())
            {
                job.setPostProfile(updatedJobPost.getPostProfile());
                job.setPostDesc(updatedJobPost.getPostDesc());
                job.setReqExperience(updatedJobPost.getReqExperience());
                job.setPostTechStack(updatedJobPost.getPostTechStack());
            }
        }
    }

    public void removeJob(int jobPostId) {
